"""
Lorehold, the Historian v15 — deck definition.
...
Costs are hand-authored. Mana values come from the spreadsheet; where a card's
real cost differs, the real cost is used and the discrepancy is noted at the
bottom of the file.
"""
...
CREATURES = [
    ...
    C("Pinnacle Monk", "Creature", {"gen": 2, "W": 1}, 3, 3, priority=4),
    C("Verge Rangers", "Creature", {"gen": 2, "W": 1}, 3, 3, priority=7, threat=5.0),
    C("Hexing Squelcher", "Creature", {"gen": 2, "R": 1}, 2, 2, priority=4),
    C("Storm-Kiln Artist", "Creature", {"gen": 3, "R": 1}, 2, 3, priority=7, threat=7.0),
    C("Urabrask // The Great Work", "Creature", {"gen": 2, "R": 2}, 4, 4,
      priority=6, threat=6.5, mana=(1, "R")),
    C("Triumph of Saint Katherine", "Creature", {"gen": 4, "W": 1}, 5, 5,
      priority=4, threat=4.5, miracle={"gen": 1, "W": 1}),
    C("Goliath Daydreamer", "Creature", {"gen": 5, "R": 1}, 6, 6, priority=4, threat=6.0),
]
...
ENCHANTMENTS = [
    ...
    C("Hidden Retreat", "Enchantment", {"gen": 2, "W": 1}, priority=8, threat=6.5),
    C("Penance", "Enchantment", {"gen": 2, "W": 1}, priority=8, threat=6.0),
    C("Monologue Tax", "Enchantment", {"gen": 2, "W": 1}, priority=6, threat=5.5,
      script="tax"),
...
INSTANTS = [
    ...
    C("Unexpected Windfall", "Instant", {"gen": 3, "R": 1}, priority=4,
      script="draw2_treasure", treasures=2, discards=1),
    C("Bolt Bend", "Instant", {"gen": 3, "R": 1}, priority=1),
    C("Invoke Calamity", "Instant", {"gen": 3, "R": 2}, priority=5, threat=6.0),
    C("Perch Protection", "Instant", {"gen": 5, "W": 1}, priority=3),
    C("Orlorin's Searing Light", "Instant", {"gen": 5, "W": 1}, priority=4, tags=("wipe", "onesided",)),
]
...
SORCERIES = [
    ...
    C("Borrowed Knowledge", "Sorcery", {"gen": 3, "R": 1}, priority=3, script="draw2"),
    C("Promise of Loyalty", "Sorcery", {"gen": 3, "W": 2}, priority=3, tags=("wipe",)),
    C("Reforge the Soul", "Sorcery", {"gen": 3, "R": 2}, priority=6, script="wheel",
      miracle={"R": 1}),
    C("Ultima", "Sorcery", {"gen": 3, "R": 1, "W": 1}, priority=5, threat=6.0, tags=("wipe",)),
    C("Farewell", "Sorcery", {"gen": 4, "W": 2}, priority=4, tags=("wipe",)),
    C("Approach of the Second Sun", "Sorcery", {"gen": 5, "W": 2}, priority=6,
      threat=8.0, script="approach"),
    C("Emeria's Call", "Sorcery", {"gen": 5, "W": 2}, priority=5, tags=("mdfc",),
      tokens=(2, 4, 4), land_face=("W", True)),
    C("Hit the Mother Lode", "Sorcery", {"gen": 5, "R": 2}, priority=5,
      script="treasures", treasures=5),
    C("Improvisation Capstone", "Sorcery", {"gen": 5, "R": 1, "W": 1}, priority=5, threat=7.0),
    C("Restoration Seminar", "Sorcery", {"gen": 5, "R": 1, "W": 1}, priority=5, threat=7.5),
    C("Volcanic Vision", "Sorcery", {"gen": 5, "R": 2}, priority=4, threat=6.5),
    C("Ondu Inversion", "Sorcery", {"gen": 6, "W": 2}, priority=3, tags=("wipe", "mdfc",),
      land_face=("W", True)),
    C("Call Forth the Tempest", "Sorcery", {"gen": 6, "R": 2}, priority=4, threat=7.0),
    ...
    C("Storm Herd", "Sorcery", {"gen": 8, "W": 2}, priority=7, threat=8.5,
      script="storm_herd"),
    C("Rise of the Eldrazi", "Sorcery", {"gen": 10, "R": 2}, priority=7, threat=9.0,
      script="extra_turn"),
]
...
MONASTERY_MENTOR = C("Monastery Mentor", "Creature", {"gen": 1, "W": 2}, 2, 2,
