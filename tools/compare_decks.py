...
Usage:  python -m tools.compare_decks [n_games]

HISTORICAL (2026-09-17). Written when the pod had no win condition and the
project had two decks; both stopped being true (pod v3, 2026-09-04, and six
engines by 2026-09-07). It still runs, on rendmaw and lorehold only, and the
"Lorehold bottlenecks" half measures levers against the v15 list. Kept as the
provenance for numbers quoted in docs/HISTORY.md; do not read its P(120) as
a win rate. Importing it no longer runs it (L2).
"""
import sys
