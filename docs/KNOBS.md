...
Derived at `f18f0c3` from 20 engine sources.
...
| `apex_ten_mana` | `True` | 2 | `edhmc/lorehold.py:720` |  | yes | yes |
...
| `artist_max_level` | `3` | 1 | `edhmc/lorehold.py:353` |  | yes | yes |
...
| `borrowed_knowledge_discard` | `True` | 2 | `edhmc/lorehold.py:717` | §0f | yes | yes |
...
| `invoke_mv_cap` | `6` | 1 | `edhmc/lorehold.py:1645` |  | **no** | yes |
| `land_animation` | `'full'` | 3 | `edhmc/azusa.py:540` | §0z19 | yes | yes |
| `land_creature_sick` | `True` | 1 | `edhmc/azusa.py:661` | §0z15 | yes | yes |
| `land_floor` | `8` | 1 | `edhmc/lorehold.py:378` | §0z30 | **no** | **never** |
| `lorehold_recursion` | `True` | 5 | `edhmc/lorehold.py:1567` | §0z28 | yes | **never** |
...
| `miracle_reserve` | `2` | 1 | `edhmc/lorehold.py:1862` |  | yes | yes |
...
| `monologue_tax_rate` | `2` | 2 | `edhmc/lorehold.py:2112` |  | **no** | **never** |
...
| `set_top_gate` | `0.0` | 1 | `edhmc/lorehold.py:572` |  | yes | **never** |
...
| `tutor_order` | `()` | 1 | `edhmc/lorehold.py:1170` |  | **no** | yes |
| `tutor_policy` | `<none>` | 2 | `edhmc/lorehold.py:1151` |  | yes | yes |
| `tutor_targets` | `()` | 1 | `edhmc/lorehold.py:1148` |  | **no** | yes |
...
**15 of 124 knobs are legacy switches, and 2 of those have never been flipped by any run** — a switch nobody has flipped is a branch
nobody has tested.

## The knobs no document mentions

**32 of 124.** Not an error — most knobs are
...
**39 of 124.** The name appears nowhere in
