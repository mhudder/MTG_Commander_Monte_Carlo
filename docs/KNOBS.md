...
Derived at `b6f957b` from 20 engine sources.

**125 knobs, 183 call sites.**
...
|---|---|---|---|---|---|---|
| `altar_keep` | `6` | 1 | `edhmc/engine.py:1749` | §0u | yes | yes |
| `altar_mana` | `True` | 1 | `edhmc/engine.py:1778` | §3 | **no** | yes |
...
| `artifact_recursion` | `True` | 1 | `edhmc/engine.py:1435` | §4 | yes | yes |
| `artist_max_level` | `3` | 1 | `edhmc/lorehold.py:354` |  | yes | yes |
| `ashaya_lands` | `True` | 1 | `edhmc/azusa.py:390` | §0z17 | yes | yes |
| `attack_triggers` | `True` | 1 | `edhmc/engine.py:2473` |  | yes | yes |
| `battlefield_creature_types` | `True` | 1 | `edhmc/engine.py:2039` | §3 | yes | yes |
| `block_rate` | `0.3` | 2 | `edhmc/engine.py:2559` | §0z42 | **no** | **never** |
| `block_share` | `0.6` | 1 | `edhmc/opponents.py:763` |  | yes | yes |
...
| `clock_rearm` | `4` | 1 | `edhmc/opponents.py:1349` |  | **no** | **never** |
| `clock_shift` | `0` | 1 | `edhmc/opponents.py:159` |  | yes | yes |
| `combat_defender` | `'weakest'` | 1 | `edhmc/opponents.py:1026` | §0z61 | **no** | yes |
| `combat_split` | `True` | 1 | `edhmc/opponents.py:1014` | §0z61 | yes | yes |
| `combat_targeting` | `'threat'` | 1 | `edhmc/opponents.py:1251` |  | yes | yes |
...
| `counter_threshold` | `4.0` | 1 | `edhmc/opponents.py:646` |  | yes | **never** |
...
| `derived_blocking` | `True` | 2 | `edhmc/engine.py:2556` | §0z42 | **no** | yes |
| `destroy_share` | `0.6` | 1 | `edhmc/opponents.py:557` |  | yes | yes |
| `devotion_creature_types` | `True` | 1 | `edhmc/engine.py:286` |  | yes | yes |
| `doll_policy` | `'nest'` | 2 | `edhmc/engine.py:2069` | §0z58 | yes | yes |
| `doll_sac_at` | `3` | 1 | `edhmc/engine.py:2097` | §0z58 | yes | yes |
| `erebos_death_draw` | `True` | 2 | `edhmc/engine.py:1386` | §0i | yes | yes |
| `erebos_life_floor` | `10` | 1 | `edhmc/engine.py:1390` | §0i | yes | yes |
| `everywhere_enters_tapped` | `True` | 1 | `edhmc/engine.py:2521` |  | yes | yes |
| `everywhere_is_token` | `True` | 1 | `edhmc/engine.py:2522` |  | yes | **never** |
...
| `first_attack_turn` | `3` | 1 | `edhmc/opponents.py:1248` |  | yes | yes |
| `first_wipe_turn` | `5` | 1 | `edhmc/opponents.py:382` |  | yes | **never** |
| `flashback_cap` | `6` | 1 | `edhmc/lorehold.py:1433` | §0u | yes | yes |
| `flier_block_share` | `0.3` | 1 | `edhmc/opponents.py:764` |  | yes | yes |
| `gingerbrute_keep` | `2` | 1 | `edhmc/karlov.py:812` | §0z19 | yes | yes |
| `goad_block_share` | `0.3` | 1 | `edhmc/opponents.py:609` |  | yes | **never** |
| `hand_cap` | `7` | 1 | `edhmc/lorehold.py:1834` |  | **no** | **never** |
| `hold_min_value` | `3.0` | 1 | `edhmc/lorehold.py:1840` |  | **no** | **never** |
| `hold_up_rate` | `0.6` | 1 | `edhmc/opponents.py:326` |  | yes | yes |
| `horn_doubled_legacy` | `False` | 2 | `edhmc/azusa.py:1031` | §0z41 | yes | yes |
| `incidental_rate` | `0.45` | 1 | `edhmc/opponents.py:1250` |  | yes | yes |
| `invoke_mv_cap` | `6` | 1 | `edhmc/lorehold.py:1650` |  | **no** | yes |
| `known_win_focus` | `1.0` | 1 | `edhmc/opponents.py:298` | §0z62 | yes | yes |
...
| `mdfc_land_floor` | `5` | 2 | `edhmc/engine.py:1698` |  | **no** | **never** |
| `miracle_reserve` | `2` | 1 | `edhmc/lorehold.py:1867` |  | yes | yes |
| `monarch_attack_floor` | `0.75` | 1 | `edhmc/opponents.py:1205` | §0z38 | yes | yes |
| `monarch_loss_scale` | `rate` | 1 | `edhmc/opponents.py:1268` | §0u | yes | yes |
| `monarch_start` | `False` | 1 | `edhmc/engine.py:1097` | §0z30 | yes | yes |
| `monarch_start_turn` | `0` | 1 | `edhmc/opponents.py:1228` | §0z28 | yes | yes |
...
| `opp_death_rate` | `0.55` | 1 | `edhmc/engine.py:2432` | §0z20 | yes | yes |
| `opp_instant_rate` | `0.8` | 2 | `edhmc/engine.py:2311` | §0z47 | yes | yes |
...
| `own_wipe_commander_returns` | `True` | 1 | `edhmc/opponents.py:1430` | §0u | yes | **never** |
| `own_wipe_indestructible` | `True` | 1 | `edhmc/opponents.py:1410` | §0u | yes | yes |
| `planeswalker_abilities` | `True` | 2 | `edhmc/azusa.py:1343` |  | yes | yes |
| `pod_brackets` | `(2, 3, 4)` | 1 | `edhmc/opponents.py:153` |  | yes | yes |
| `pod_damage_full_pod` | `True` | 1 | `edhmc/opponents.py:868` | §0u | yes | yes |
| `pod_reads_battlefield_creatures` | `True` | 1 | `edhmc/opponents.py:239` | §0y | yes | yes |
| `protection_cards` | `('Heroic Intervention',)` | 1 | `edhmc/opponents.py:319` |  | yes | **never** |
...
| `shroud_sources` | `()` | 1 | `edhmc/opponents.py:314` |  | yes | **never** |
...
| `wipe_threshold` | `1.4` | 1 | `edhmc/opponents.py:1365` |  | yes | **never** |
...
**15 of 125 knobs are legacy switches, and 2 of those have never been flipped by any run** — a switch nobody has flipped is a branch
nobody has tested.

## The knobs no document mentions

**32 of 125.** Not an error — most knobs are
...
**39 of 125.** The name appears nowhere in
